...
1. YAML Front Matter in any other file ([read more](https://jekyllrb.com/docs/front-matter/))
...
> ###### Note (May 2026)
>
> Notice that `site.data.tags[0]` is empty... But how are there still tags under the post titles?
>
> This blog began with a theme that didn't support Jekyll tags, so I added support with a (clunky) custom clump of bash and liquid scripts paired with nested include templates.
>
> Today's theme has support for tags and Jekyll gives [access to them in two ways](https://jekyllrb.com/docs/posts/#tags).
>
> | Variable  | Contents        | Origin |
> |-----------|-----------------|--------|
> | site.tags | {% for tag in site.tags %}{{ tag[0] }}, {% endfor %} | Jekyll |
> | page.tags | {{ page.tags | join: ", " }} | Jekyll |
